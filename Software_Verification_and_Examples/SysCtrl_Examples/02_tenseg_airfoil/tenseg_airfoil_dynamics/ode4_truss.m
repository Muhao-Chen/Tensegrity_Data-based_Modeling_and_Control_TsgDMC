function data_out = ode4_truss(odefun,tspan,y0,data_in)
...
global l q E f n n_d f_int l_int
data_out=data_in;  %initialize output data
out_tspan=data_in.out_tspan;
ne=data_in.ne;
nn= data_in.nn;
l_int=data_in.l0;           % initialize the intermidiate variable
f_int=zeros(size(data_in.l0));
%%
if ~isnumeric(tspan)
